...
git clone git@github.com:open-mmlab/PowerPaints.git
...
python pwrpt_inference.py --share
```
...
python pwrpt_inference.py --share --version ppt-v2 --checkpoint_dir checkpoints/ppt-v2
```
