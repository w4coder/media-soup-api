...
from migan.lib.model_zoo.common.get_model import get_model, register
from migan.lib.model_zoo.common import utils

version = '2'
symbol = 'stylegan'

from migan.torch_utils import misc
from migan.torch_utils.ops import upfirdn2d, conv2d_gradfix, conv2d_resample, fma
