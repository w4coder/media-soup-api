...
from models.pwrpaint.models import BrushNetModel
from models.pwrpaint.models.unet_2d_condition import UNet2DConditionModel
from models.pwrpaint.pipelines import StableDiffusionInpaintPipeline as Pipeline
from models.pwrpaint.pipelines import StableDiffusionPowerPaintBrushNetPipeline
from models.pwrpaint.pipelines import (
    StableDiffusionControlNetInpaintPipeline as controlnetPipeline,
)
from models.pwrpaint.utils.utils import TokenizerWrapper, add_tokens
...
class PowerPaintController:
    ...
    def load(self):
        print("powerpaint loaded")

    def unload(self):
        print("powerpaint unloaded")
...
if __name__ == "__main__":
    ...
    args.add_argument("--checkpoint_dir", type=str, default="D:\Projects\ImageProcModel\pwrpaint\checkpoints\ppt-v2")
    ...
    with gr.Blocks(css="style.css") as demo:
        ...
        print([
                    text_guided_prompt.value,
                    text_guided_negative_prompt.value,
                    shape_guided_prompt.value,
                    shape_guided_negative_prompt.value,
                    fitting_degree.value,
                    ddim_steps.value,
                    scale.value,
                    seed.value,
                    task.value,
                    vertical_expansion_ratio.value,
                    horizontal_expansion_ratio.value,
                    outpaint_prompt.value,
                    outpaint_negative_prompt.value,
                    removal_prompt.value,
                    removal_negative_prompt.value,
                ])
        if args.version == "ppt-v1":
            run_button.click(
                fn=controller.infer,
